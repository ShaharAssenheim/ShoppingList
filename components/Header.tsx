...
export const Header: React.FC = () => {
  return (
    <header className="pt-6 pb-6 md:pt-2 md:pb-4 flex justify-center items-center px-4" role="banner">
      <div className="w-full max-w-2xl text-center animate-in slide-in-from-top-4 fade-in duration-700">
        ...
        ">
          ...
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-96 h-96 bg-indigo-100/20 rounded-full blur-3xl -z-10" aria-hidden="true"></div>
           ...
           <div className="flex justify-center gap-6 md:gap-8 mb-5 md:mb-6 text-4xl md:text-5xl animate-float" aria-hidden="true">
          ...
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-black text-slate-800 mb-3 md:mb-4 tracking-tight leading-[1.15]">
            <span className="text-[#6366f1]">רשימת</span>{' '}
            <span className="text-slate-800 relative inline-block">
              קניות
              {/* Decorative underline */}
              <svg className="absolute -bottom-1 md:-bottom-2 left-0 w-full h-2 md:h-3 text-indigo-200" viewBox="0 0 100 10" preserveAspectRatio="none" aria-hidden="true">
          ...
          <p className="text-slate-500 font-medium text-base md:text-lg lg:text-xl max-w-lg mx-auto leading-relaxed">
